...
// GENERO EL METODO PARA CARGAR EL FRAGMENT LOGIN LUEGO DEL CLICK.
    ...
    @Override
    public void irATrivia(Integer tipoFormatoTrivia) {
        Intent intent = new Intent(this, ActivityTrivia.class);
        Bundle unBundle = new Bundle();
        unBundle.putInt(ActivityTrivia.QUEMUESTRO, tipoFormatoTrivia);
